...
function draw() {
  ...
  if(keyDown(LEFT_ARROW)){
    ...
    balloon.addAnimation("cityImageO1.png")
  }
  else if(keyDown(RIGHT_ARROW)){
    updateHeight(10,0);
    //add the animation of balloon [use balloonImage2]
    balloon.addAnimation("HotAirBallonO1.png")
  }
  else if(keyDown(UP_ARROW)){
    updateHeight(0,-10);
 //add the animation of balloon [use balloonImage2]
 balloon.addAnimation("HotAirBallonO2.png")
    balloon.scale=balloon.scale -0.005;
  }
  else if(keyDown(DOWN_ARROW)){
    updateHeight(0,+10);
  //add the animation of balloon [use balloonImage2]
  balloon.addAnimation("HotAirBallonO3.png")
    balloon.scale=balloon.scale+0.005;
  }
